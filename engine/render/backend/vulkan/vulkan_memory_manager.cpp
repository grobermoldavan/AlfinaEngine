...
namespace al
{
    ...
    void construct_memory_manager(VulkanMemoryManager* memoryManager, AllocatorBindings* bindings)
    {
        ...
        array_construct(&memoryManager->gpu_chunks, bindings, VulkanMemoryManager::GPU_MAX_CHUNKS);
        array_construct(&memoryManager->gpu_ledgers, bindings, VulkanMemoryManager::GPU_LEDGER_SIZE_BYTES * VulkanMemoryManager::GPU_MAX_CHUNKS);
